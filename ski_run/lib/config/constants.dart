...
const double initialBaseSpeed = 18.0;
const double maxSpeedGain = 55.0;
const double initialTrailWidth = 1.0;
const double minTrailWidth = 0.55;
const double initialObstacleRate = 35.0;
const double minObstacleRate = 6.0;
const double difficultyDistance = 15000.0;
const double initialObstacleZ = 50.0;
